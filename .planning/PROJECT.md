...
### Active
- [ ] NOTIFY-01: Daily review notification (prompts logging)
- [ ] DATA-02: Export/import data as backup file
...
| Matter.js + Skia for physics (ADR-005) | Lightweight, proven in Expo ecosystem | — Pending |
...
| Daily review = notification only (ADR-012) | Lightweight, no extra screen | — Pending |
...
| Split analytics execution (ADR-022) | Charts first, physics second — reduces risk | — Pending |
| react-native-gifted-charts (ADR-024) | Native-optimized, highest perf priority | — Pending |
| Simplified physics boundary (ADR-025) | 60fps with cartoonish segmented SVG | — Pending |
| Physics ball aggregation (ADR-026) | Prevents memory overflow on high log counts | — Pending |
